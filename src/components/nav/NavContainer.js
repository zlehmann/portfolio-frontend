...
class NavContainer extends Component {
  ...
  render () {
    return (
      <div id="nav">
        <div id="techButton">
          <TechButton currentSelection={this.props.currentSelection} action={this.props.handleClick} scale={this.props.scale}/>
        </div>
        <div id="navIcon" width={300 * this.props.scale} height={300 * this.props.scale}>
          ...
          <img id="home" alt="Home" src={process.env.PUBLIC_URL + '/home.png'} width={90*this.props.scale}/>
